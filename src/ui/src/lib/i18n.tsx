...
const messages = {
  en: {
    ...
    openQuestDelete: 'Delete quest',
    openQuestDeleteTitle: 'Delete quest?',
    openQuestDeleteBody: 'This will permanently delete the quest repo on disk. This cannot be undone.',
  ...
  zh: {
    ...
    openQuestDelete: '删除 quest',
    openQuestDeleteTitle: '确认删除 quest？',
    openQuestDeleteBody: '这会永久删除本地 quest 仓库内容，且无法恢复。',
